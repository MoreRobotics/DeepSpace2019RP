...
/**
* GripPipelineDeepSpace class.
*
* <p>An OpenCV pipeline generated by GRIP.
*
* @author GRIP
*/
public class GripPipelineDeepSpace implements VisionPipeline {
	...
	@Override	public void process(Mat source0) {
		...
		double[] hsvThresholdHue = {27.007017858111126, 71.40041781391437};
		double[] hsvThresholdSaturation = {146.76258992805754, 255.0};
		double[] hsvThresholdValue = {35.35120147874307, 255.0};
